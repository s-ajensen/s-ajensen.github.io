...
var G__4572 = o;
goog.object.set(G__4572,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__4573__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__4573 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__4574__i = 0, G__4574__a = new Array(arguments.length -  0);
while (G__4574__i < G__4574__a.length) {G__4574__a[G__4574__i] = arguments[G__4574__i + 0]; ++G__4574__i;}
  args = new cljs.core.IndexedSeq(G__4574__a,0,null);
} 
return G__4573__delegate.call(this,args);};
G__4573.cljs$lang$maxFixedArity = 0;
G__4573.cljs$lang$applyTo = (function (arglist__4575){
var args = cljs.core.seq(arglist__4575);
return G__4573__delegate(args);
});
...
var G__4576 = o;
goog.object.set(G__4576,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__4577__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__4577 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__4578__i = 0, G__4578__a = new Array(arguments.length -  0);
while (G__4578__i < G__4578__a.length) {G__4578__a[G__4578__i] = arguments[G__4578__i + 0]; ++G__4578__i;}
  args = new cljs.core.IndexedSeq(G__4578__a,0,null);
} 
return G__4577__delegate.call(this,args);};
G__4577.cljs$lang$maxFixedArity = 0;
G__4577.cljs$lang$applyTo = (function (arglist__4579){
var args = cljs.core.seq(arglist__4579);
return G__4577__delegate(args);
});
...
var G__4580 = props;
var G__4580__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__4580,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__4580);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__4580__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__4581 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__4581,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__4581;
}
})(),id_class);
...
var G__4582 = (cljs.core.count.call(null,argv) - first_child);
switch (G__4582) {
case (0):
...
var vec__4584 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__4584,(0),null);
var id = cljs.core.nth.call(null,vec__4584,(1),null);
var className = cljs.core.nth.call(null,vec__4584,(2),null);
...
var temp__5808__auto___4587 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___4587 == null)){
} else {
var key_4588 = temp__5808__auto___4587;
(jsprops.key = key_4588);
}
...
var temp__5808__auto___4589 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___4589 == null)){
} else {
var key_4590 = temp__5808__auto___4589;
(jsprops.key = key_4590);
}
...
var temp__5808__auto___4591 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5808__auto___4591 == null)){
} else {
var key_4592 = temp__5808__auto___4591;
(jsprops.key = key_4592);
}
...
var temp__5808__auto___4593 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___4593 == null)){
} else {
var key_4594 = temp__5808__auto___4593;
(jsprops.key = key_4594);
}
...
var temp__5808__auto___4595 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___4595 == null)){
} else {
var key_4596 = temp__5808__auto___4595;
(jsprops.key = key_4596);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__4597_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__4597_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__4598 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__4598,(0),null);
var derefed = cljs.core.nth.call(null,vec__4598,(1),null);
...
break;
default:
var G__4603 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__4604 = compiler;
v = G__4603;
compiler = G__4604;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template4608 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template4608 = (function (opts,id,fn_to_element,parse_fn,meta4609){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta4609 = meta4609;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template4608.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_4610,meta4609__$1){
var self__ = this;
var _4610__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template4608(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta4609__$1));
}));

(reagent.impl.template.t_reagent$impl$template4608.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_4610){
var self__ = this;
var _4610__$1 = this;
return self__.meta4609;
}));

(reagent.impl.template.t_reagent$impl$template4608.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template4608.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template4608.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template4608.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template4608.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template4608.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta4609","meta4609",201297296,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template4608.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template4608.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template4608");

(reagent.impl.template.t_reagent$impl$template4608.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write.call(null,writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template4608");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template4608.
 */
reagent.impl.template.__GT_t_reagent$impl$template4608 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template4608(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta4609){
return (new reagent.impl.template.t_reagent$impl$template4608(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta4609));
});

}

return (new reagent.impl.template.t_reagent$impl$template4608(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
