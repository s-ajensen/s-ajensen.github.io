...
var G__8262 = o;
goog.object.set(G__8262,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__8266 = o;
goog.object.set(G__8266,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__8268__i < G__8268__a.length) {G__8268__a[G__8268__i] = arguments[G__8268__i + 0]; ++G__8268__i;}
  args = new cljs.core.IndexedSeq(G__8268__a,0,null);
} 
...
var G__8270 = props;
var G__8270__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8270,cljs.core.cst$kw$id,id):G__8270);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8270__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__8271 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8271,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__8271;
}
})(),id_class);
...
var G__8272 = (cljs.core.count(argv) - first_child);
switch (G__8272) {
case (0):
...
break;
case (1):
var G__8273 = component;
var G__8274 = jsprops;
var G__8275 = reagent.impl.protocols.as_element(this$,cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__8273,G__8274,G__8275);
...
var vec__8277 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8277,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8277,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8277,(2),null);
...
var temp__5808__auto___8280 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___8280 == null)){
} else {
var key_8281 = temp__5808__auto___8280;
(jsprops.key = key_8281);
}
...
var temp__5808__auto___8284 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___8284 == null)){
} else {
var key_8285 = temp__5808__auto___8284;
(jsprops.key = key_8285);
}

var G__8282 = reagent.impl.component.functional_render_fn(compiler,tag);
var G__8283 = jsprops;
return reagent.impl.template.global$module$react.createElement(G__8282,G__8283);
});
/**
...
var temp__5808__auto___8286 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___8286 == null)){
} else {
var key_8287 = temp__5808__auto___8286;
(jsprops.key = key_8287);
}
...
var temp__5808__auto___8288 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___8288 == null)){
} else {
var key_8289 = temp__5808__auto___8288;
(jsprops.key = key_8289);
}
...
var temp__5808__auto___8290 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___8290 == null)){
} else {
var key_8291 = temp__5808__auto___8290;
(jsprops.key = key_8291);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__8292_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__8292_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__8293 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8293,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8293,(1),null);
...
break;
default:
var G__8298 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__8299 = compiler;
v = G__8298;
compiler = G__8299;
continue;
...
var G__8300 = tag;
var G__8300__$1 = (((G__8300 instanceof cljs.core.Keyword))?G__8300.fqn:null);
switch (G__8300__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template8303 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template8303 = (function (opts,id,fn_to_element,parse_fn,meta8304){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta8304 = meta8304;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template8303.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_8305,meta8304__$1){
var self__ = this;
var _8305__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template8303(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta8304__$1));
}));

(reagent.impl.template.t_reagent$impl$template8303.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_8305){
var self__ = this;
var _8305__$1 = this;
return self__.meta8304;
}));

(reagent.impl.template.t_reagent$impl$template8303.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template8303.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template8303.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template8303.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template8303.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template8303.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$opts,cljs.core.cst$sym$id,cljs.core.cst$sym$fn_DASH_to_DASH_element,cljs.core.cst$sym$parse_DASH_fn,cljs.core.cst$sym$meta8304], null);
}));

(reagent.impl.template.t_reagent$impl$template8303.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template8303.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template8303");

(reagent.impl.template.t_reagent$impl$template8303.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template8303");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template8303.
 */
reagent.impl.template.__GT_t_reagent$impl$template8303 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template8303(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta8304){
return (new reagent.impl.template.t_reagent$impl$template8303(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta8304));
});

}

return (new reagent.impl.template.t_reagent$impl$template8303(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
