...
var board = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(state);
var new_board = ttt.move.move.call(null,selection,ttt.move.cur_token.call(null,board),board);
if(cljs.core.not.call(null,ttt.move.game_over_QMARK_.call(null,new_board))){
return ttt.move.next_move.call(null,new cljs.core.Keyword(null,"difficulty","difficulty",755680807).cljs$core$IFn$_invoke$arity$1(state),new_board);
} else {
return new_board;
}
});
...
cljs.core._add_method.call(null,ttt.game.progress_game,new cljs.core.Keyword(null,"cvc","cvc",1488701754),(function (state,selection){
var board = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(state);
while(true){
