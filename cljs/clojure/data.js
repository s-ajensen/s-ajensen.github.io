...
return cljs.core.reduce.call(null,(function (result,p__5138){
...
var vec__5142 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__5142,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__5142,(1),null);
var ab = cljs.core.nth.call(null,vec__5142,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_5148 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_5148.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_5149 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_5149.call(null,a,b);
}
});
...
return (function (){var G__5153 = clojure.data.equality_partition.call(null,a);
var G__5153__$1 = (((G__5153 instanceof cljs.core.Keyword))?G__5153.fqn:null);
switch (G__5153__$1) {
case "atom":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__5153__$1)].join('')));
